...
# Load the CSV files
baseline_wifi_df = pd.read_csv('csv/baseline_wifi_257.csv')
baseline_lte_df = pd.read_csv('csv/baseline_lte_257.csv')
baseline_random_wifi_df = pd.read_csv('csv/baseline_random_wifi_257.csv')
baseline_random_lte_df = pd.read_csv('csv/baseline_random_lte_257.csv')
multi_protocol_df = pd.read_csv('csv/multi_protocol_257.csv')
...
plt.grid(True)
plt.savefig('images/privacy_leakage_257.pdf', dpi=600)
# plt.show()

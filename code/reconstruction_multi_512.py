...
ml = MyLogger("reconstruction_multiprotocol_500")
...
md.set_collection('reconstruction_baseline_500')
documents = md.collection.find()
...
multi_protocol_df.to_csv('csv/multi_protocol_500.csv', index=False)
md.db['reconstruction_multiproto_500'].drop()
md.db['reconstruction_multiproto_500'].insert_many(multi_data)
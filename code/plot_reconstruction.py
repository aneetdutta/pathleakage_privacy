...
plt.plot(baseline_lte_users, baseline_lte_scores_sorted, label='Naive Baseline (LTE)', marker='p')
...
plt.title('Privacy Leakage for Naive Baseline and Multi-Protocol',fontsize=14)

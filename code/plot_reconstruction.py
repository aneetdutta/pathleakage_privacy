...
plt.plot(baseline_wifi_users, baseline_wifi_scores_sorted, label='Naive Baseline (Wifi)', marker='o')
plt.plot(baseline_lte_users, baseline_lte_scores_sorted, label='Naive Baseline (LTE)', marker='o')
plt.plot(baseline_random_wifi_users, baseline_random_wifi_scores_sorted, label='Baseline+Localization(Wifi)', marker='p')
plt.plot(baseline_random_lte_users, baseline_random_lte_scores_sorted, label='Baseline+Localization(LTE)', marker='p')

...
md.set_collection('baseline_intra_mappings_64')
...
wifi_df.to_csv('csv/baseline_random_wifi_64.csv', index=False)
lte_df.to_csv('csv/baseline_random_lte_64.csv', index=False)

...
for timestep_pair in timestep_pairs:
    ...
    intra_potential_mapping, inter_potential_mapping, visited_inter_list, visited_intra_list, intra_mapping_checker =  tracking_algorithm_modified(timestep_pair, intra_potential_mapping=intra_potential_mapping, inter_potential_mapping=inter_potential_mapping, visited_inter_list=visited_inter_list, visited_intra_list=visited_intra_list, intra_mapping_checker=intra_mapping_checker)

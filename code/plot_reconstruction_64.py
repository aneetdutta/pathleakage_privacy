...
# Load the CSV files
baseline_wifi_df = pd.read_csv('csv/baseline_wifi_64.csv')
# print(baseline_wifi_df)
baseline_lte_df = pd.read_csv('csv/baseline_lte_64.csv')
baseline_random_wifi_df = pd.read_csv('csv/baseline_random_wifi_64.csv')
baseline_random_lte_df = pd.read_csv('csv/baseline_random_lte_64.csv')
multi_protocol_df = pd.read_csv('csv/multi_protocol_64.csv')
# multi_protocol_500_df = pd.read_csv('csv/multi_protocol_500_64.csv')
...
plt.plot(baseline_wifi_users, baseline_wifi_scores_sorted, label='Naive Baseline (Wifi)', alpha=0.5)
plt.plot(baseline_lte_users, baseline_lte_scores_sorted, label='Naive Baseline (LTE)')
plt.plot(baseline_random_wifi_users, baseline_random_wifi_scores_sorted, label='Baseline+Localization(Wifi)', alpha=0.5)
...
plt.grid(True)
plt.savefig('images/privacy_leakage_64.pdf', dpi=600)
# plt.show()

...
if ENABLE_BLUETOOTH:
    plt.plot(baseline_ble_users, baseline_ble_scores_sorted, label='Naive Baseline (Bluetooth)', alpha=0.7)
if ENABLE_SMART_TRACKING:
    ...
    if ENABLE_BLUETOOTH:
        plt.plot(baseline_smart_ble_users, baseline_smart_ble_scores_sorted, label='Baseline & Localization (Bluetooth)', alpha=0.7)

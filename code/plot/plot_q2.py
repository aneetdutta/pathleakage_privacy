...
plt.plot(baseline_loc_wifi_users, baseline_loc_wifi_scores_sorted, label='Single Protocol (WiFi)', alpha=0.7, linewidth=3, color="#bf5b17", marker='<', markevery=marker_interval)
...
plt.plot(baseline_loc_ble_users, baseline_loc_ble_scores_sorted, label='Single Protocol (Bluetooth)', alpha=0.7, linewidth=3, color="#a6d854", marker='>', markevery=marker_interval)
...
plt.plot(baseline_loc_lte_users, baseline_loc_lte_scores_sorted, label='Single Protocol (LTE)', alpha=0.7, linewidth=3, color="#e7298a", marker='p', markevery=marker_interval)

...
# Load the CSV files
# baseline_wifi_df = pd.read_csv(f'csv/baseline_wifi_scenario8a1.csv')
...
# baseline_ble_df = pd.read_csv(f'csv/baseline_ble_scenario8a1.csv')
...
# baseline_lte_df = pd.read_csv(f'csv/baseline_lte_scenario8a1.csv')
...
baseline_smart_wifi_df = pd.read_csv(f'csv/baseline_smart_wifi_scenario8a1.csv')
...
plt.plot(baseline_smart_wifi_users, baseline_smart_wifi_scores_sorted, label='Single Protocol (WiFi)', linestyle='-', alpha=0.7, linewidth=3, color="#c994c7", marker='o', markevery=marker_interval)

baseline_smart_ble_df = pd.read_csv(f'csv/baseline_smart_ble_scenario8a1.csv')
...
plt.plot(baseline_smart_ble_users, baseline_smart_ble_scores_sorted, label='Single Protocol (Bluetooth)', linestyle='-', alpha=0.7, linewidth=3, color="#8da0cb", marker='s', markevery=marker_interval)

baseline_smart_lte_df = pd.read_csv(f'csv/baseline_smart_lte_scenario8a1.csv')
...
plt.plot(baseline_smart_lte_users, baseline_smart_lte_scores_sorted, label='Single Protocol (LTE)', linestyle='-', alpha=0.7, linewidth=3, color="#fdc086", marker='v', markevery=marker_interval)


multi_protocol_df = pd.read_csv(f'csv/multi_protocol_scenario8a1.csv')  
...
plt.plot(multi_protocol_users, multi_protocol_scores_sorted, label='Multi-Protocol (LTE, WiFi, Bluetooth)', alpha=0.7, linewidth=3, color="#31a354", marker='*', markevery=marker_interval)
...
count_users_privacy_1 = multi_protocol_ml_df[multi_protocol_ml_df['privacy_score'] == 1.0].shape[0]
count_users_privacy_2 = multi_protocol_ml_df[multi_protocol_ml_df['privacy_score'] >= 0.95].shape[0]
count_users_privacy_3 = multi_protocol_ml_df[multi_protocol_ml_df['privacy_score'] >= 0.9].shape[0]
count_users_privacy_4 = multi_protocol_ml_df[multi_protocol_ml_df['privacy_score'] >= 0.8].shape[0]
plt.plot(multi_protocol_ml_users, multi_protocol_ml_scores_sorted, label='Multi-Protocol with Multilateration (LTE, WiFi, Bluetooth)', alpha=0.7, linewidth=3, color="#f03b20", marker='*', markevery=marker_interval)
...
plt.savefig(f'images/privacy_leakage_q5.pdf', dpi=600, bbox_inches='tight')
plt.show()

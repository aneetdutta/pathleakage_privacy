...
ml = MyLogger("reconstruction_baseline_64")
...
wifi_df.to_csv('csv/baseline_wifi_64.csv', index=False)
wifi_data = wifi_df.to_dict(orient='records')
md.db['reconstruction_baseline'].insert_many(wifi_data)
lte_df.to_csv('csv/baseline_lte_64.csv', index=False)
# lte_data = lte_df.to_dict(orient='records')
# md.db['reconstruction_baseline_64'].insert_many(lte_data)
...
#     md.db['inter_mappings_64'].drop()
#     md.db['inter_mappings_64'].insert_many(inter_df.to_dict(orient='records'))
#     md.db['intra_mappings_64'].drop()
#     md.db['intra_mappings_64'].insert_many(intra_df.to_dict(orient='records'))

bl_data = bl_df.to_dict(orient='records')
md.db['reconstruction_baseline_64'].drop()
md.db['reconstruction_baseline_64'].insert_many(bl_data)

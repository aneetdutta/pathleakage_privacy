from services.grouping_algorithm import group_distances
...
sniffer_group = [
    {'protocol': 'LTE', 'lte_id': 'L1', 'WiFi_id': None, 'bluetooth_id': None, 'dist_S_U': 40},
    {'protocol': 'WiFi', 'lte_id': None, 'WiFi_id': 'W1', 'bluetooth_id': None, 'dist_S_U': 40},
    {'protocol': 'Bluetooth', 'lte_id': None, 'WiFi_id': None, 'bluetooth_id': 'B1', 'dist_S_U': 40},
    {'protocol': 'LTE', 'lte_id': 'L2', 'WiFi_id': None, 'bluetooth_id': None, 'dist_S_U': 30},
    {'protocol': 'WiFi', 'lte_id': None, 'WiFi_id': 'W2', 'bluetooth_id': None, 'dist_S_U': 30},
    {'protocol': 'Bluetooth', 'lte_id': None, 'WiFi_id': None, 'bluetooth_id': 'B2', 'dist_S_U': 30},
    {'protocol': 'LTE', 'lte_id': 'L3', 'WiFi_id': None, 'bluetooth_id': None, 'dist_S_U': 20},
    {'protocol': 'WiFi', 'lte_id': None, 'WiFi_id': 'W3', 'bluetooth_id': None, 'dist_S_U': 20},

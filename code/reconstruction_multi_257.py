...
ml = MyLogger("reconstruction_multiprotocol_257")

reconstruct_until_timestep = 18364

md.set_collection('modified_intra_mappings_257')
...
md.set_collection('modified_inter_mappings_257')
...
print(multi_protocol_df.head(100))

multi_data = multi_protocol_df.to_dict(orient='records')
# print(multi_protocol_df.to_string())
multi_protocol_df.to_csv('csv/multi_protocol_257.csv', index=False)
md.db['reconstruction_multiproto_257'].drop()
md.db['reconstruction_multiproto_257'].insert_many(multi_data)